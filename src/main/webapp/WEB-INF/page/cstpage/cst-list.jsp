...
<section class="Hui-article-box" >
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20" style="background-color:rgb(129,216,209)">
                <span class="r">共有数据：<strong>${totals}</strong> 条</span>
            </div>
            <table class="table table-border table-bordered table-bg" id="mytable">
                <thead style="background-color:rgb(129,216,209)"> 
                <tr style="background-color:rgb(129,216,209)">
                    <th scope="col" colspan="10">订单列表</th>
                </tr>
                <tr class="text-c" style="background-color:rgb(129,216,209)">
