...
<div class="main">
		<div class="login-form">
			...
			<form action="/login" method="POST">
				<input name="name" id="name" type="text" class="text" value="用户名" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '用户名';}" />
				<input  name="password" id="password" placeholder="密码" type="password"  value="" />
