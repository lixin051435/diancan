    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" style="color:rgb(129,216,209)">
                    发布资讯！
                </h4>
            </div>
            <!--登陆框中间部分(from表单)-->
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contents" class="col-sm-4 control-label" style="color:rgb(129,216,209)">输入信息</label>
                    <div class="col-sm-12">
                        <textarea class="form-control" name="content" id="contents" placeholder="与大家分享美食资讯" required="required"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color:rgb(129,216,209)">关闭</button>
                        <button type="button" class="btn btn-default"  id="modalFabu" style="background-color:rgb(129,216,209)">发布</button>
                    </div>
                </div>
                <%--</form>--%>
            </div>
