                ...
                <div class="breadcrumb-container">
                    <nav>
                        <ul>
                            ...
                            <li style="color:rgb(129,216,209)">登录</li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                ...
                <form action="/fore/foreLogin" method="post" class="loginForm">
                    ...
                    <div class="login-form">
                        ...
                        <h4 class="login-title" style="color:rgb(129,216,209)">登录</h4>

                        <div class="row">
                            <div class="col-md-12 col-12 mb-20">
                                <label style="color:rgb(129,216,209)">用户名</label>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="register-button mt-0" style="background-color:rgb(129,216,209)">登陆</button>
                            </div>
